...
output_analysis_dir = Path(output_dir, analysis_dir)
output_data_dir = Path(output_dir, data_dir)


move_assets(output_analysis_dir, public_dir)
move_assets(output_data_dir, public_dir)
